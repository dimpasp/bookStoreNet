    ...
    public class LocalizedIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError()
            {
                ...
                Description = string.Format("Duplicate Email", email)
            };
        }
        ...
        public override IdentityError DuplicateUserName(string userName)
        {
            return new IdentityError()
            {
                ...
                Description = string.Format("Duplicate UserName On Customer")
            };
        }
        ...
        public override IdentityError InvalidEmail(string email)
        {
            return new IdentityError()
            {
                ...
                Description = string.Format("Invalid Email", email)
            };
        }
        ...
        public override IdentityError PasswordRequiresLower()
        {
            return new IdentityError()
            {
                ...
                Description = "Password Requires Lower"
            };
        }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric()
        {
            return new IdentityError()
            {
                ...
                Description = "Password Requires Non Alphanumeric"
            };
        ...
        public override IdentityError PasswordRequiresUpper()
        {
            return new IdentityError()
            {
                ...
                Description = "Password Requires Upper"
            };
